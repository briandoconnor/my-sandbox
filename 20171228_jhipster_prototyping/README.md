...
## Dependencies
    ...
    $> "/Applications/Postgres.app/Contents/Versions/10/bin/psql" -p5432 -d "postgres"
    $> postgres=# create database consonance;
...
To optimize the consonance application for production, run:
